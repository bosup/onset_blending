...
def calc_onsets_rowwise(df, day_cols, day_ints, win, params=None):
    ...
    ----------
    df : DataFrame
    day_cols : list of str
    day_ints : list of int
    win : int  (kept for legacy; params.win takes precedence when params given)
    params : OnsetParams from read_onset_params(), or None for defaults
